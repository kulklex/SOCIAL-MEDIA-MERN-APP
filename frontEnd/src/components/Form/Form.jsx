    ...
    <>
      <Paper className={classes.paper}>
        <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
          ...
          value={postData.creator} onChange={(e) => {setPostData({...postData, message: e.target.value})}} />
          <TextField name="tags" variant='outlined' label="Tags" fullWidth  value={postData.creator} onChange={(e) => {setPostData({...postData, tags: e.target.value})}} />
           ...
           <Button className={classes.buttonSubmit} 
              ...
              <Button  
              variant="contained" color='secondary' size='small' onClick={clear} fullWidth >Clear</Button>
        </form>
      </Paper>
    </>
  )
